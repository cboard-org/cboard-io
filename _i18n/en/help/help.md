...
* 2. [What is Cboard?](#WhatisCboard)
* 3. [Registration and login](#Registrationandlogin)
	* 3.1. [How do I register for Cboard?](#HowdoIregisterforCboard)
	* 3.2. [Can I register myself using my social media accounts?](#CanIregistermyselfusingmysocialmediaaccounts)
	* 3.3. [How do I log in to Cboard once I am a registered user?](#HowdoIlogintoCboardonceIamaregistereduser)
	* 3.4. [How do I logout?](#HowdoIlogout)
	* 3.5. [What is the difference between a registered and a non-registered user?](#Whatisthedifferencebetweenaregisteredandanon-registereduser)
	* 3.6. [How do I update my user information?](#HowdoIupdatemyuserinformation)
	* 3.7. [How do I reset my password?](#HowdoIresetmypassword)
* 4. [Price](#Price)
	* 4.1. [How much does Cboard cost?](#HowmuchdoesCboardcost)
* 5. [Features](#Features)
	* 5.1. [What devices and OS are supported?](#WhatdevicesandOSaresupported)
	* 5.2. [Which languages are supported by Cboard?](#WhichlanguagesaresupportedbyCboard)
	* 5.3. [Can Cboard read my message out aloud?](#CanCboardreadmymessageoutaloud)
	* 5.4. [Speech capabilities](#Speechcapabilities)
	* 5.5. [Export and import](#Exportandimport)
	* 5.6. [Display capabilities](#Displaycapabilities)
	* 5.7. [Can I change any navigation settings?](#CanIchangeanynavigationsettings)
	* 5.8. [Navigation trough the interface](#Navigationtroughtheinterface)
* 6. [Settings](#Settings)
	* 6.1. [How do I access settings in Cboard?](#HowdoIaccesssettingsinCboard)
	* 6.2. [How do I print my board set in Cboard?](#HowdoIprintmyboardsetinCboard)
	* 6.3. [How do I see Cboard in fullscreen?](#HowdoIseeCboardinfullscreen)
	* 6.4. [How do I share a board?](#HowdoIshareaboard)
* 7. [Talking](#Talking)
	* 7.1. [How do I add a personally recorded voice to symbols on Cboard?](#HowdoIaddapersonallyrecordedvoicetosymbolsonCboard)
	* 7.2. [How do I remove symbols from the output bar?](#HowdoIremovesymbolsfromtheoutputbar)
	* 7.3. [How do I switch to a different voice?](#HowdoIswitchtoadifferentvoice)
	* 7.4. [How do I change how a voice sounds?](#HowdoIchangehowavoicesounds)
* 8. [Board Editing](#BoardEditing)
	* 8.1. [How do I create an empty board?](#HowdoIcreateanemptyboard)
	* 8.2. [How do I personalize an existing board in Cboard?](#HowdoIpersonalizeanexistingboardinCboard)
	* 8.3. [Can I use my own pictures when editing a board?](#CanIusemyownpictureswheneditingaboard)
	* 8.4. [Can I change the ordering of the elements in a board?](#CanIchangetheorderingoftheelementsinaboard)
	* 8.5. [How do I select multiple elements to edit?](#HowdoIselectmultipleelementstoedit)
* 9. [Export and import](#Exportandimport-1)
	* 9.1. [How do I export my board in Cboard?](#HowdoIexportmyboardinCboard)
	* 9.2. [How do I import a board into Cboard?](#HowdoIimportaboardintoCboard)
	* 9.3. [What file format does Cboard use for import/export?](#WhatfileformatdoesCboarduseforimportexport)
* 10. [Display capabilities](#Displaycapabilities-1)
	* 10.1. [What can I change on the display?](#WhatcanIchangeonthedisplay)
	* 10.2. [Can I resize buttons on Cboard?](#CanIresizebuttonsonCboard)
* 11. [Scanning](#Scanning)
	* 11.1. [Can I use scanning techniques to access symbols?](#CanIusescanningtechniquestoaccesssymbols)

##  2. <a name='WhatisCboard'></a>What is Cboard?
...
##  3. <a name='Registrationandlogin'></a>Registration and login 

###  3.1. <a name='HowdoIregisterforCboard'></a>How do I register for Cboard?
...
###  3.2. <a name='CanIregistermyselfusingmysocialmediaaccounts'></a>Can I register myself using my social media accounts?
...
###  3.3. <a name='HowdoIlogintoCboardonceIamaregistereduser'></a>How do I log in to Cboard once I am a registered user?
...
###  3.4. <a name='HowdoIlogout'></a>How do I logout?
...
###  3.5. <a name='Whatisthedifferencebetweenaregisteredandanon-registereduser'></a>What is the difference between a registered and a non-registered user?
...
###  3.6. <a name='HowdoIupdatemyuserinformation'></a>How do I update my user information?
...
###  3.7. <a name='HowdoIresetmypassword'></a>How do I reset my password?

In order to reset your password, please e-mail support@cboard.io and we will get back to you. 

##  4. <a name='Price'></a>Price 

###  4.1. <a name='HowmuchdoesCboardcost'></a>How much does Cboard cost?

Cboard is completely free of any charge.

##  5. <a name='Features'></a>Features 

###  5.1. <a name='WhatdevicesandOSaresupported'></a>What devices and OS are supported?
...
###  5.2. <a name='WhichlanguagesaresupportedbyCboard'></a>Which languages are supported by Cboard?
...
###  5.3. <a name='CanCboardreadmymessageoutaloud'></a>Can Cboard read my message out aloud?
...
###  5.4. <a name='Speechcapabilities'></a>Speech capabilities
...
###  5.5. <a name='Exportandimport'></a>Export and import 
...
###  5.6. <a name='Displaycapabilities'></a>Display capabilities 
...
###  5.7. <a name='CanIchangeanynavigationsettings'></a>Can I change any navigation settings?
...
###  5.8. <a name='Navigationtroughtheinterface'></a>Navigation trough the interface 
...
##  6. <a name='Settings'></a>Settings 

###  6.1. <a name='HowdoIaccesssettingsinCboard'></a>How do I access settings in Cboard?
...
###  6.2. <a name='HowdoIprintmyboardsetinCboard'></a>How do I print my board set in Cboard?
...
###  6.3. <a name='HowdoIseeCboardinfullscreen'></a>How do I see Cboard in fullscreen?
...
###  6.4. <a name='HowdoIshareaboard'></a>How do I share a board?
...
##  7. <a name='Talking'></a>Talking 

###  7.1. <a name='HowdoIaddapersonallyrecordedvoicetosymbolsonCboard'></a>How do I add a personally recorded voice to symbols on Cboard?
...
###  7.2. <a name='HowdoIremovesymbolsfromtheoutputbar'></a>How do I remove symbols from the output bar?

###  7.3. <a name='HowdoIswitchtoadifferentvoice'></a>How do I switch to a different voice?
...
###  7.4. <a name='HowdoIchangehowavoicesounds'></a>How do I change how a voice sounds?

In order to adjust speech capabilities/voice/sound, go into settings, and under the 'Language' category is the 'Speech' category. When you press 'Speech' you will be able to edit the pitch and pace of speech on Cboard. You can also record your own voice for the symbols following the steps 
on the answer from how to start talking on the app. You can also record your own voice for the symbols following the steps on the answer for “How do I add a personally recorded voice to symbols on Cboard?”

##  8. <a name='BoardEditing'></a>Board Editing

###  8.1. <a name='HowdoIcreateanemptyboard'></a>How do I create an empty board?
...
###  8.2. <a name='HowdoIpersonalizeanexistingboardinCboard'></a>How do I personalize an existing board in Cboard?
...
###  8.3. <a name='CanIusemyownpictureswheneditingaboard'></a>Can I use my own pictures when editing a board?
...
###  8.4. <a name='CanIchangetheorderingoftheelementsinaboard'></a>Can I change the ordering of the elements in a board?
...
###  8.5. <a name='HowdoIselectmultipleelementstoedit'></a>How do I select multiple elements to edit?
...
##  9. <a name='Exportandimport-1'></a>Export and import 

###  9.1. <a name='HowdoIexportmyboardinCboard'></a>How do I export my board in Cboard?

In order to export your board in Cboard, go to settings, and as soon as you open Settings, the Export option will appear as a downward facing arrow, right below Language and Speech.

Click on Export, and you will be able to download your Cboard by clicking on either ‘OpenBoard’ or EXPORT.


###  9.2. <a name='HowdoIimportaboardintoCboard'></a>How do I import a board into Cboard?
...
###  9.3. <a name='WhatfileformatdoesCboarduseforimportexport'></a>What file format does Cboard use for import/export?
...
##  10. <a name='Displaycapabilities-1'></a>Display capabilities 


###  10.1. <a name='WhatcanIchangeonthedisplay'></a>What can I change on the display?
...
###  10.2. <a name='CanIresizebuttonsonCboard'></a>Can I resize buttons on Cboard?
...
##  11. <a name='Scanning'></a>Scanning 

###  11.1. <a name='CanIusescanningtechniquestoaccesssymbols'></a>Can I use scanning techniques to access symbols?
